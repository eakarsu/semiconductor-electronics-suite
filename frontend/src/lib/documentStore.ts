...
const seed: DocumentRecord[] = [
  { id: 'doc-1', name: 'Lots Packet', type: 'Lots', owner: 'Manufacturing Lead', status: 'In review', updatedAt: '2026-05-24 10:00' },
  { id: 'doc-2', name: 'Wafers Review Bundle', type: 'Wafers', owner: 'Operations Lead', status: 'Approval pending', updatedAt: '2026-05-24 11:20' },
  { id: 'doc-3', name: 'Recipes Evidence Set', type: 'Recipes', owner: 'Governance Lead', status: 'Ready', updatedAt: '2026-05-24 09:35' },
];
