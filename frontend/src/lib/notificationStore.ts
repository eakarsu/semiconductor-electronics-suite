...
const seed: NotificationItem[] = [
  { id: 'note-1', title: 'Lots alert', detail: 'Lots queue needs review.', read: false },
  { id: 'note-2', title: 'Wafers approval due', detail: 'Wafers exception list needs approval.', read: false },
  { id: 'note-3', title: 'Recipes updated', detail: 'Recipes operating queue was refreshed.', read: true },
];
