export const AUTH_COOKIE = 'semiconductor_electronics_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@semiconductor-electronics.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@semiconductor-electronics.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@semiconductor-electronics.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
