...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Semiconductor Electronics Dashboard"
      subtitle="One merged semiconductor electronics view for Lots, Wafers, Recipes, Equipment, Yield, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared semiconductor electronics jobs into one surface. Lots, Wafers, Recipes, Equipment, Yield, Defects, documents, audit, and AI are presented as platform features.</div>
