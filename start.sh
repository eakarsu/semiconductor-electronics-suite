...
PORT="${PORT:-4680}"
DB_NAME="${PGDATABASE:-semiconductor_electronics_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Semiconductor Electronics Suite"
echo "======================================="
echo
...
echo "Starting semiconductor electronics suite frontend on http://localhost:$PORT"
echo "Login: admin@semiconductor-electronics.local / admin123"
